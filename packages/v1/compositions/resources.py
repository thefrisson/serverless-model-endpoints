...
composition_a = ['external_account_type_generic_groups_explore_groups', 'solution_template_generic_groups_explore_groups', 'users_stripe_passports']

composition_b = ['solution_templates_workflow_templates']
